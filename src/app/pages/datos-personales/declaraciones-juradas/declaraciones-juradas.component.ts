...
@Component({
  ...
  templateUrl: './declaraciones-juradas.component.html',
  styleUrls: ['./declaraciones-juradas.component.css'],
  providers: [MessageService]

})
export class DeclaracionesJuradasComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/DECLARACIONES JURADAS`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "DECLARACIONES JURADAS",
