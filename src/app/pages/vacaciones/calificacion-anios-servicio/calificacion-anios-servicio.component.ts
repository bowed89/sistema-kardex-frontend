...
@Component({
  selector: 'app-calificacion-anios-servicio',
  templateUrl: './calificacion-anios-servicio.component.html',
  styleUrls: ['./calificacion-anios-servicio.component.css'],
  providers: [MessageService]
})
export class CalificacionAniosServicioComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/CALIFICACION DE ANIOS DE SERVICIO`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "CALIFICACION DE ANIOS DE SERVICIO",
