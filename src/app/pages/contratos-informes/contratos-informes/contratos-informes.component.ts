...
@Component({
  selector: 'app-contratos-informes',
  templateUrl: './contratos-informes.component.html',
  styleUrls: ['./contratos-informes.component.css'],
  providers: [MessageService]
})
export class ContratosInformesComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/CONTRATOS E INFORMES`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "CONTRATOS E INFORMES",
