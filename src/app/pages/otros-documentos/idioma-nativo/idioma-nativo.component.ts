...
@Component({
  selector: 'app-idioma-nativo',
  templateUrl: './idioma-nativo.component.html',
  styleUrls: ['./idioma-nativo.component.css'],
  providers: [MessageService]
})
export class IdiomaNativoComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/IDIOMA NATIVO`
      }
