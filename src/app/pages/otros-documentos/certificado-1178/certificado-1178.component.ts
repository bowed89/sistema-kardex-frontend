...
@Component({
  selector: 'app-certificado-1178',
  templateUrl: './certificado-1178.component.html',
  styleUrls: ['./certificado-1178.component.css'],
  providers: [MessageService]
})
export class Certificado1178Component implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/CERTIFICADO 1178 CENCAP-EGPP`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "CERTIFICADO 1178 CENCAP-EGPP",
