...
@Component({
  selector: 'app-certificado-politicas-publicas',
  templateUrl: './certificado-politicas-publicas.component.html',
  styleUrls: ['./certificado-politicas-publicas.component.css'],
  providers: [MessageService]
})
export class CertificadoPoliticasPublicasComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/CERTIFICADO POLITICAS PUBLICAS CENCAP-EGPP`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "CERTIFICADO POLITICAS PUBLICAS CENCAP-EGPP",
