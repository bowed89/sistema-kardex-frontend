...
@Component({
  selector: 'app-certificado-egpp',
  templateUrl: './certificado-egpp.component.html',
  styleUrls: ['./certificado-egpp.component.css'],
  providers: [MessageService]
})
export class CertificadoEgppComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/CERTIFICADO RESP. FUNCION PUBLICA CENCAP-EGPP`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "CERTIFICADO RESP. FUNCION PUBLICA CENCAP-EGPP",
