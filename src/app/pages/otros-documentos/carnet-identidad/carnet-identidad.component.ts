...
@Component({
  selector: 'app-carnet-identidad',
  templateUrl: './carnet-identidad.component.html',
  styleUrls: ['./carnet-identidad.component.css'],
  providers: [MessageService]
})
export class CarnetIdentidadComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/CARNET DE IDENTIDAD`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "CARNET DE IDENTIDAD",
