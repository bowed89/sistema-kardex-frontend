...
@Component({
  selector: 'app-libreta-militar',
  templateUrl: './libreta-militar.component.html',
  styleUrls: ['./libreta-militar.component.css'],
  providers: [MessageService]
})
export class LibretaMilitarComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/LIBRETA MILITAR`
      }
