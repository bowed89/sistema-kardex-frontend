...
@Component({
  ...
  templateUrl: './memorandum2.component.html',
  styleUrls: ['./memorandum2.component.css'],
  providers: [MessageService]
})
export class Memorandum2Component implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/MEMORANDUMS 2DA PARTE`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "MEMORANDUMS 2DA PARTE",
