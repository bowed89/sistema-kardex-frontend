...
@Component({
  selector: 'app-certificados-cursos',
  templateUrl: './certificados-cursos.component.html',
  styleUrls: ['./certificados-cursos.component.css'],
  providers: [MessageService]

})
export class CertificadosCursosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/CERTIFICADO DE CURSOS`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "CERTIFICADO DE CURSOS",
