...
@Component({
  selector: 'app-desvinculacion-laboral',
  templateUrl: './desvinculacion-laboral.component.html',
  styleUrls: ['./desvinculacion-laboral.component.css'],
  providers: [MessageService]
})
export class DesvinculacionLaboralComponent implements OnInit {
  cols: any[];
  idPersonal: number;
  nombre: string;
  ...
  ngOnInit(): void {
    ...
    this._datosPersonalesService.getPersonalById(this.idPersonal).subscribe(res => {
      ...
      this.findUrl = {
        url: `../Uploads/${this.nombre}/DESVINCULACION LABORAL`
      }
  ...
  preview(files: FileList) {
    ...
    let url = {
      "tipoProceso": "DESVINCULACION LABORAL",
